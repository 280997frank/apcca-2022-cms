      ...
      >
        ...
        >
          <Center h="100%" flexDir="column">
            <Icon as={MdFileUpload} color="#222222" fontSize="2.5rem" />
            <Text color="#222222" fontWeight="bold" textAlign="center">
              Upload {accept === "image" ? "Thumbnail" : ""}
              {accept === "all" ? "Image/Video" : ""}
              {accept === "video" ? "Video" : ""}
              {accept === "application/pdf" ? "Document" : ""}
            </Text>
            <Text color="#222222" fontWeight="bold">
